...
| [`scripts/CLAUDE.md`](scripts/CLAUDE.md) | Claude | Architecture reference for `AI-transcript.py`: key section line numbers, hunk data structure, grep pipeline threading pattern. |
